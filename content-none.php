...
<div class="entry-content">
    <article>
    <h1><?php _e( 'No content found for that request', 'jacqui' ); ?></h1>
    <h2><?php _e( 'You may want to try a search for similar content.<br> You can use this search bar.', 'jacqui' ); ?></h2>
